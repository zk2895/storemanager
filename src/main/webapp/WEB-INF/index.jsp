        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">${sessionScope.currentMember.username }</a>
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" layuimini-content-href="page/password.jsp" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
