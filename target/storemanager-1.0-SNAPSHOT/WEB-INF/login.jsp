        ...
        <form class="layui-form login-bottom" action="/login" method="post"> 
            <div class="center">
               ...
               <div id="validatePanel" class="item" style="width: 137px;">
						<label>
							<input type="text" name="captcha" placeholder="区分大小写" maxlength="6">
						</label>
						<a href="javascript:change();" rel="external nofollow" title="看不清，换一张？">
							<img id="refreshCaptcha" class="validateImg"  src="/image" alt="#">
						</a>
					</div>
...
//点一下验证码图片，换一下验证码
     function change(){
	document.getElementById("refreshCaptcha").src = "/image?r=" + Math.random();
    }
